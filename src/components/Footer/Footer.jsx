        ...
        <div className={`${darkMode ? "bg-color_4" : "bg-gray-700"} flex flex-col md:flex-row md:justify-center ms:content-center flex-wrap w-full box-border font-text py-6`}>
            <div className="flex md:flex-row w-screen md:w-1/3 ">
                <div className="flex flex-wrap w-full md:justify-center md:content-center md:flex-col">
                    <div className="flex w-full">
                        <h3 className={`${darkMode ? "text-cyan-700" : "text-dark_4"} font-bold mx-auto text-3xl sm:text-4xl`}>¿Quien soy?</h3>
                    </div>
                    <div className="flex md:flex-wrap w-full md:mx-auto py-5">
                        <div className={`${darkMode ? "text-cyan-700" : "text-gray-100"} w-4/5 md:w-7/8 mx-auto text-justify font-mono font-medium`}>
            ...
            <div className="flex md:flex-row w-screen md:w-1/3 ">
                <div className="flex w-full h-96 ">
                    <img src={Foto} alt="Jacobo Jácome" className=" object-cover mx-auto rounded-full" />
                </div>
            </div>
            <div className="flex w-screen md:w-1/3 md:flex-row">
                <div className="flex flex-wrap w-screen md:justify-center md:content-center md:flex-col">
                    <div className="flex w-screen md:w-1/2">
                        <h3 className={`${darkMode ? "text-cyan-700" : "text-dark_4"} font-bold mx-auto text-3xl sm:text-4xl`}>Contacto</h3>
                    </div>
                    <div className="flex md:flex-wrap md:justify-center md:content-center w-screen md:w-1/2 mx-auto py-5">
                        <div className={`w-1/5 m-2 mx-auto md:mx-2 flex flex-col md:w-20 md:p-0 rounded-full shadow-xl ${darkMode ? "shadow-gray-700/40" : "shadow-gray-200/40"}  hover:-translate-y-2 hover:scale-110 transition ease-in-out delay-150`}>
                    ...
                    <div className="flex md:flex-wrap mx-auto md:flex-row justify-center content-center ">
                        ...
                        <spam className={`${darkMode ? "text-cyan-700" : "text-gray-100"} my-auto`}>jacobojacome@gmail.com</spam>
                    </div>
                </div>
            </div>
